...
<form action="http://localhost/PAGINA/resources/templates/back/accEditar_producto.php" method="post">

<?php $query = editarProductos2(); 
...
<div class="form-group">
    <label for="product-title">Titulo </label>
        <input type="text" name="prod_titulo" class="form-control" value='<?php $query['prod_titulo'] ?>'>
